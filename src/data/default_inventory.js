/**
 * Default Inventory Catalog for HoReCa & Export Operations
 * Structured across Farm Produce, Butchery, Fishery, and Global Export.
 */
...
export const DEFAULT_INVENTORY = [
  ...
  },
  {
    ...
    sku: "FSH-TIL-002",
    name: "Fresh Lake Victoria Tilapia Fillets (Skin-on/Skinless)",
    category: "Fish & Seafood",
    price: 1100,
    currency: "KES",
    unit: "kg",
  ...
  },
  {
    ...
    sku: "FSH-SNA-004",
    name: "Coastal Red Snapper (Fresh Ocean Catch)",
    category: "Fish & Seafood",
    price: 880,
    currency: "KES",
    unit: "kg",
    ...
    inStock: 280,
    moq: 5,
    origin: "Indian Ocean (Kilifi & Malindi Landing Sites)",
    grade: "Grade 1 Whole Fish (1.0 - 2.5kg)",
    coldStorage: "Wet Flake Ice (0°C)",
    description: "Line-caught Indian Ocean red snapper with succulent sweet flakes. Arrives overnight via Mombasa-Nairobi refrigerated cold transit.",
    isExportGrade: false,
  ...
  },
  {
    ...
    sku: "FSH-PRA-005",
    name: "Jumbo Ocean Tiger Prawns (Head-On Shell-On)",
    category: "Fish & Seafood",
    price: 2400,
    currency: "KES",
    unit: "kg",
    ...
    grade: "U-10 (Under 10 pieces per kg) & U-15",
    coldStorage: "Chilled Fresh / Blast Frozen (-18°C)",
    description: "Massive sweet prawns for garlic butter flambé and sizzling seafood platters in premier luxury restaurants.",
    isExportGrade: true,
